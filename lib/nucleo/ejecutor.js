...
module.exports = class{
    ...
    __ejecutarMetodo(metodo, resultadoAnterior){
        ...
        return (async () => {
            ...
            this.__enviarAccion("EJECUTAR_PASO", {id: procesoId, paso: metodo});
            ...
            try{
                ...
                this.__enviarAccion("PASO_ERRONEO", {id: procesoId, paso: metodo});
            ...
            this.__enviarAccion("PASO_EJECUTADO", {id: procesoId, paso:metodo});
